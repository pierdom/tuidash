...
# Char codes: '.' transparent, 'Y'/'y' sun (bright/dim), 'H' highlight,
#             'W'/'w' cloud (main/shadow), 'G'/'g' storm cloud (main/shadow),
#             'b' rain, 's' snow, 'L' lightning, 'F'/'f' fog (bright/dim)

_C: dict[str, str | None] = {
    ".": None,
    "Y": "gold1",
    "y": "dark_goldenrod",   # dim sun outer ring
    "H": "grey93",            # bright highlight (cloud top, moon edge)
    "W": "grey82",            # main cloud / moon body
    "w": "grey58",            # cloud shadow underside
    "G": "grey46",            # dark storm cloud
    "g": "grey30",            # darker storm cloud shadow
    "b": "deep_sky_blue1",
    "s": "bright_white",
    "L": "bright_yellow",
    "f": "grey62",            # fog
    "F": "grey70",            # bright fog stripe
}
